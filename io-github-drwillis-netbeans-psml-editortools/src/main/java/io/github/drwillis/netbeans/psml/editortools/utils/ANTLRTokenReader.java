 ...
 */
package io.github.drwillis.netbeans.psml.editortools.utils;
...
import io.github.drwillis.netbeans.psml.editortools.lexer.PSML2Lexer;
import io.github.drwillis.netbeans.psml.editortools.lexer.PSMTokenId;
...
public class ANTLRTokenReader {
    ...
    public List<PSMTokenId> readTokenFile() {
        ...
        InputStream inp = classLoader.getResourceAsStream("io/github/drwillis/netbeans/psml/editortools/utils/PSML2.tokens");
